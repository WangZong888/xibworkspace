...
!function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        onAll: function (name, args) { tt();return false;},
        onClickRow: function (item, $element) {tt();return false;},
        onDblClickRow: function (item, $element) {tt();return false;},
        onSort: function (name, order) {tt();return false;},
        onCheck: function (row) {tt();return false;},
        onUncheck: function (row) {rtt();return false;},
        onCheckAll: function () {tt();return false;},
        onUncheckAll: function () {tt();return false;},
        onLoadSuccess: function (data) {tt();return false;},
        onLoadError: function (status) {tt();return false;},
        onColumnSwitch: function (field, checked) {tt();return false;},
        onPageChange: function (number, size) {tt();return false;},
        onSearch: function (text) {tt();return false;}
    };
